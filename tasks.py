...
- hard_routing: correct step1 = 0.88, step2 = 0.68, step3 = 0.48; wrong = 0.12, repeated wrong = 0.05
"""
...
class TaskManager:
    ...
    def grade_hard(self, action_dept: str, correct_dept: str, step_number: int, previous_actions: list, adjacent_depts: list = None) -> float: 
        """Hard: step1 correct = 0.88, step2 = 0.68, step3 = 0.48; wrong = 0.12, repeated wrong = 0.05."""
        if not action_dept:
            return 0.12
        action_dept_clean = str(action_dept).strip().lower()
        correct_dept_clean = str(correct_dept).strip().lower()
